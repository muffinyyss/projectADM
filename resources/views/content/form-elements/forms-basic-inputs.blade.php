        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body demo-vertical-spacing demo-only-element">
                    ...
                    <div class="form-floating form-floating-outline">
                        <input type="text" readonly class="form-control-plaintext px-0"
        ...
        <div class="col-xl-6">
            ...
            <div class="card mb-6">
                ...
                <div class="card-body">
                    ...
                    <div class="form-floating form-floating-outline mb-6">
                        <input class="form-control" type="url" placeholder="{{ config('variables.templateName') }}"
                            id="html5-url-input" />
                        <label for="html5-url-input">URL</label>
                    </div>
                    <div class="form-floating form-floating-outline mb-6">
                        <input class="form-control" type="tel" placeholder="90-(164)-188-556"
                            id="html5-tel-input" />
