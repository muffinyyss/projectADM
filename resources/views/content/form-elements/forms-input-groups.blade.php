                ...
                <div class="card-body demo-vertical-spacing demo-only-element">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="Recipient's username"
                            aria-label="Recipient's username" aria-describedby="basic-addon43" />
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="URL" id="basic-url441"
        ...
        <div class="col-md-6">
            <div class="card mb-6">
                ...
                <div class="card-body demo-vertical-spacing demo-only-element">
                    ...
                    <div class="input-group">
                        <div class="input-group-text form-check mb-0">
                            <input class="form-check-input m-auto" type="radio" value=""
